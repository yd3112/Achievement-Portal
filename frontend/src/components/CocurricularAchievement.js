    ...
    return(
      ...
      <div>
        ...
        <div className="flex">
            ...
            <div className="pt-20">
              <h1 style={{fontSize: "2.5rem"}}><u>Cocurricular Achievers</u></h1>
...
export default CocurricularAchievement;